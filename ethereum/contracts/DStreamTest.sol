...
//THIS CONTRACT IS USED IN OUR TEST CASES
//THE DIFFERENCE BETWEEN THIS CONTRACT AND 
//THE MAIN CONTRACT IS THAT THE VERIFY FUNCTION
//IMPLEMENTATION IS DIFFERENT BECAUSE 
// GANACHE PROVIDER DOES NOT SUPPORT 
// PERSONAL_SIGN
...
contract Video {
    ...
    */
    function verify(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s, address _address)
